...
class Jogo:
    ...
    def _jogo_draw(self):
        # Fundo: ceu e agua
        self.tela.fill(AZUL_CEU)
        pygame.draw.rect(self.tela, VERDE,    (0, ALTURA//2 - 40, LARGURA, 40))
        pygame.draw.rect(self.tela, AZUL_MAR, (0, ALTURA//2,      LARGURA, ALTURA//2))

        # Instrucoes temporarias
        txt = self.fonte_pequena.render("S = Loja  |  ESC = Menu", True, BRANCO)
